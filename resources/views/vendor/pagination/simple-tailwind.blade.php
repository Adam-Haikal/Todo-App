@if ($paginator->hasPages())
    <nav role="navigation"
        ...
        @if ($paginator->onFirstPage())
            <span
                class="relative inline-flex cursor-default items-center rounded-md border border-gray-300 bg-gray-200 px-4 py-2 text-sm font-medium leading-5 text-gray-500">
